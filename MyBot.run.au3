...
Func UpdateBotTitle()
	Local $sTitle = "My Bot " & $g_sBotVersion & " AIO-MOD  " & $g_sModversion & " by : AbdAlla  "
...
Func FinalInitialization(Const $sAI)
	...
	SetLog("___________ " & "ALO MOD" & "___________", $COLOR_MONEYGREEN, "Impact", 14)
	SetLog("                                 » " & "اصدار البوت المطور " & " «", $COLOR_TEAL, "Segoe UI Semibold", 12)
	SetLog("         » " & "*************** " & " «", $COLOR_TEAL, "Segoe UI Semibold", 10)
	SetLog("           » " & "قام باعداد هذا الاصدار الفريق العربي للتطوير " & " «", $COLOR_TEAL, "Segoe UI Semibold", 9)
	SetLog("-----------------------------------------------------------------------", $COLOR_MONEYGREEN)
	SetLog("     » " & "تطوير: ABDALL AL MHMOOD ^ FIRAS ASWD ^  آل الخال  ^ AMER ALI " & " «", $COLOR_TEAL, "Segoe Print", 8)
	SetLog("     » " & "شكر خاص : عزوزي / AWS SAAD / تقي حسين / احمد ابراهيم العيد / سيدمجتبى  " & " «", $COLOR_TEAL, "Segoe Print", 9)
	SetLog("         » " & "اختبار البوت من قبل : AHMAD AWAD / HAMOOD SPIKY / ALI MOHAMMED /  " & " «", $COLOR_TEAL, "Segoe Print", 9)
	SetLog("-----------------------------------------------------------------------", $COLOR_MONEYGREEN)
	SetLog("                      » " & "Based On: MyBot " & $g_sBotVersion & " «", $COLOR_TEAL, "Segoe UI Semibold", 10)
	SetLog("                         » " & "ALO MOD" & " " & $g_sModversion & " «", $COLOR_TEAL, "Segoe UI Semibold", 10)
	SetLog("-----------------------------------------------------------------------", $COLOR_MONEYGREEN)
