...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		Case $g_hTabMain
			...
			Local $aIconIndex = [$eIcnMOD4, $eIcnTH12, $eIcnMOD8, $eTitan, $eIcnMOD9, $eIcnMOD5]
		...
		Case $g_hGUI_TRAINARMY_TAB
			...
			Local $aIconIndex = [$eIcnMOD8, $eIcnGem, $eIcnReOrder, $eIcnOptions]
		...
		Case $g_hGUI_ATTACK_TAB
			...
			Local $aIconIndex = [$eIcnMOD8, $eIcnMagnifier, $eIcnStrategies]
		...
		Case $g_hGUI_MOD_TAB
		    ; the icons for ALO MOD tab
			Local $aIconIndex = [$eIcnMOD1, $eIcnMOD2, $eIcnMOD3, $eIcnMOD4, $eIcnMOD5, $eIcnMOD6]
